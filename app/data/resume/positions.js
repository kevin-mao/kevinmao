...
const positions = [
  {
    ...
    points: [
      ...
      + 'without any code by building new features, such as deleting a row, a new datetime column type,'
  ...
  },
  {
    ...
    points: [
      ...
      'Conducting data signal processing steps, such as PCA and FFT, optimized model parameters using'
